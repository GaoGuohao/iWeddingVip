...
ZSSEditor.focusOutFirstEditableField = function() {
    $('div[contenteditable=true]:first').blur();
};
...
ZSSEditor.insertLocalImage = function(imageNodeIdentifier, localImageUrl) {
    ...
    var html = imgContainerStart +image + imgContainerEnd;
...
ZSSEditor.replaceLocalImageWithText = function(imageNodeIdentifier,text){
    ...
    ZSSEditor.markImageUploadFailed(imageNodeIdentifier,text);
//    ZSSEditor.removeImage(imageNodeIdentifier);
//    $("dddd").ins
//    this.insertBefore(imageNode，"ddddddd");
//    
//    
//    if (imageNode.length > 0) {
//        imageNode.unwrap();
